...
published: true
---
Yesterday `CERT.GOV.GE` hosted CyberCube-2020 in Georgia.For the first time Olympiad was hosted online Due to COVID-19.Exercises were kinda CTFish, but it was a lot of fun.
...
So we decode it and redirect output to final2.txt
...
![](https://raw.githubusercontent.com/0x70sec/0x70sec.github.io/master/assets/cybercube2020/35.png)
